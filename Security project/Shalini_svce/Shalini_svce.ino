 ...
 
{
  ...
  mySerial.println("AT+CMGS=\"9345688790\"\r"); // Replace x with mobile number
  delay(200);
...
/*void SendMessage1()
{
  ...
  delay(200);
  mySerial.println("Alert someone opened the gate 2 ");// The SMS text you want to send
 ...
 void SendMovement()
{
  mySerial.println("AT+CMGF=1");    //Sets the GSM Module in Text Mode
  delay(1000);  // Delay of 1000 milli seconds or 1 second
  mySerial.println("AT+CMGS=\"+919444077371\"\r"); // Replace x with mobile number
  delay(200);
